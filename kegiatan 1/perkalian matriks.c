Ada beberapa kesalahan sintaksis dalam kode yang Anda berikan. Saya akan membantu memperbaikinya. Perhatikan bahwa Anda tidak perlu mendeklarasikan ulang variabel matriks1, matriks2, dan hasil setelah mendeklarasikan mereka pada awal program.
...
int main() {
    ...
    int hasilPerkalian[3][3]; // Perbaiki deklarasi hasilPerkalian
    int i, j, k;
    int m, n, p;
...
Beberapa perbaikan termasuk penambahan tanda `